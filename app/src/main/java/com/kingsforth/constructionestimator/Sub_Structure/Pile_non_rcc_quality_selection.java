...
public class Pile_non_rcc_quality_selection extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tv_quality_for.setText("Pile Non circular Rcc ");
			...
			public void onClick(View v) {
                if(check_radio.equals("")){ // if check radio is empty
                    ...
                    if (ed_sand_input.getText().toString().trim().equals("")) {
                        ...
                        Pile_non_rcc_enter_values objFragment = new Pile_non_rcc_enter_values();
