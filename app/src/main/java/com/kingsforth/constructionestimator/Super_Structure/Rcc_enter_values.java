...
public class Rcc_enter_values extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View rootView = inflater.inflate(R.layout.slab_rcc_enter_values, container, false);
...
//**************End Radio Main bar Click ******************
    ...
    public void send_result(){
        ...
        Slab_rcc_result frag = new Slab_rcc_result();
