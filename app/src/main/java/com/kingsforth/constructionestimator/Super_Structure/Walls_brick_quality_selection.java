...
public class Walls_brick_quality_selection extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		tv_for.setText("For Walls brick..");
//******************   Radio Button Clicks   *************************
            ...
            public void onClick(View v) {
                ...
                if(check_radio.equals("")){ // if check radio is empty
                    ...
                    if (ed_sand_input.getText().toString().trim().equals("")) {
                        ...
                        Walls_brick_enter_values objFragment = new Walls_brick_enter_values();
