...
public class Footing_quality_selection extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tv_quality_for.setText("Raft footing");
		...
		btn_nxt.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(check_radio.equals("")){
					...
					if(ed_sand_input.getText().toString().trim() == "" || ed_cement_input.getText().toString().trim() == "" || ed_crush_input.getText().toString().trim() == "")
					{
                        ...
                        Footing_enter_values objFragment = new Footing_enter_values();
