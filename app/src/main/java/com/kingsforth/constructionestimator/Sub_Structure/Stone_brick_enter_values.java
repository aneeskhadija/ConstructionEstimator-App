...
public class Stone_brick_enter_values extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View rootView = inflater.inflate(R.layout.stone_brick_enter_values, container, false);
		//banner adds
...
//        area =    area  -  Integer.parseInt(ed_deduction.getText().toString().trim());
    ...
    public void send_result(){
        ...
        Stone_brick_result frag = new Stone_brick_result();
