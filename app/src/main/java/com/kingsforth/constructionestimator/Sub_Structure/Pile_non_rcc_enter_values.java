...
public class Pile_non_rcc_enter_values extends Fragment {
...
//    TextView tv_title;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View rootView = inflater.inflate(R.layout.non_rcc_enter_values, container, false);
...
//**************End Radio Main bar Click ******************
    ...
    public void send_result(){
        ...
        Pile_non_rcc_result frag = new Pile_non_rcc_result();
...
//DB Log & main bar
        ...
        if(db_cursor.getCount() == 1) {
            ...
            if(tiebar_radio==1){
                ...
                db_main_log_price       = db_cursor.getString(db_cursor.getColumnIndex("onfour_price"));
