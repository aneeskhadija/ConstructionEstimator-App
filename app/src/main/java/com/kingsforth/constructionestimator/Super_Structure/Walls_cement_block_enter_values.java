...
public class Walls_cement_block_enter_values extends Fragment {
...
//        Toast.makeText(getActivity(), "cement_quality "+cement_quality, Toast.LENGTH_SHORT).show();
//        Toast.makeText(getActivity(), "sand_quality "+sand_quality, Toast.LENGTH_SHORT).show();
    ...
    public void calculation_for_result(){
        ...
        area =    Double.parseDouble(ed_length.getText().toString().trim()) * (Double.parseDouble(ed_width.getText().toString().trim()) /12 ) * (Double.parseDouble(ed_height.getText().toString().trim())  );
        ...
        double quality_a = Double.parseDouble(cement_quality);
                Double quality_b = Double.parseDouble(sand_quality)
                ;
    ...
    public void send_result(){
        ...
        Walls_cement_block_result frag = new Walls_cement_block_result();
