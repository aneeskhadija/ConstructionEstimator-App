...
public class Slab_brick_enter_values extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View rootView = inflater.inflate(R.layout.slab_brick_enter_values, container, false);
		//banner adds
    ...
    public void calculation_for_result(){
        ...
        b_a  =    (Double.parseDouble(ed_percentage.getText().toString().trim()) / 100) * area;
    ...
    public void send_result(){
        ...
        slab_brick_result frag = new slab_brick_result();
