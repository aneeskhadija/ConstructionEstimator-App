...
public class Non_cement_block_quality_selection extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		tv_for.setText("For Non Circular Column Cement block..");
			...
			public void onClick(View v) {
                ...
                if(check_radio.equals("")){ // if check radio is empty
                    ...
                    if (ed_sand_input.getText().toString().trim().equals("")) {
                        ...
                        Non_cement_block_enter_values objFragment = new Non_cement_block_enter_values();
