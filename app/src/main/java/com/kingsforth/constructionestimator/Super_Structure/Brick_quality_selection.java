...
public class Brick_quality_selection extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		tv_for.setText("For Non Circular Column brick..");
			...
			public void onClick(View v) {
                ...
                if(check_radio.equals("")){ // if check radio is empty
                    ...
                    if (ed_sand_input.getText().toString().trim().equals("")) {
                        ...
                        Brick_enter_values objFragment = new Brick_enter_values();
